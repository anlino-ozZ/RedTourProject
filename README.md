...
| 文件 | 内容 |
| --- | --- |
| `01_代码统一规范.md` | 前后端 Python 代码规范、Git 分支规则、命名约定 |
| `02_UI全局设计规范.md` | 红色主题样式、组件规范、设计 token |
| `03_系统架构&硬件清单.md` | 系统架构图、AI 技术要点、树莓派硬件清单、部署拓扑 |
| `04_精简PRD开发要点.md` | 产品需求精简版、功能模块要点 |
| `05_全局接口精简文档.md` | 前后端 AI 统一接口文档、错误码、数据模型 |
| `06_开发环境搭建清单.md` | 各角色本地环境搭建步骤、自检清单、常见问题 |
| `07_前后端联调指南.md` | 联调模式、接口路径与鉴权、跨域说明、故障排查 |
